  ...
  *One-class* methods such as Deep SVDD learn a compact hypersphere
  ...
  $
    min_(theta, Pi) quad F(theta) + lambda_1 op("Comm")(Pi) + lambda_2 op("Latency")(Pi) + lambda_3 op("Robust")(theta, Pi),
  $
  ...
  *(iii)* Krum, which selects the update minimising the sum of distances to its
  ...
  $
    x_f^((k))(t) = A_k (sin(2 pi f_k t + phi_f) + h_k sin(4 pi f_k t + phi_f))
                    + epsilon_f^((k))(t) + b_f^((k)),
  $
